...
public class ModelView extends Layaout {
    ...
    private JComboBox<Model.Type> cmb_model_typ;
    ...
    public ModelView(Model model) {
        ...
        this.model = model;
        this.initilizeGui(300, 500);

        for (Brand brand : this.brandManager.findAll()) {
            this.cmb_brand.addItem(new ComboItem(brand.getId(), brand.getName()));  // generic bir yapı
        }
        ...
        this.cmb_model_typ.setModel(new DefaultComboBoxModel<>(Model.Type.values()));
        ...
        if (this.model.getId() != 0) {
            ...
            this.cmb_model_typ.getModel().setSelectedItem(this.model.getType());
        ...
        this.btn_model_save.addActionListener(e -> {
            if (Helper.isFieldListEmpty(new JTextField[]{this.fld_model_name, fld_model_year})) {
                ...
                this.model.setType((Model.Type) cmb_model_typ.getSelectedItem());
